<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="MainSite.About" ValidateRequest="false"%>
    ...
    <div class="row">
      <%--  height: auto; er en workaround for at jeg kan ikke skifte på bootstrap col-md-4 sin høyde.--%>
        <div class="col-md-4" style ="height: auto;">
            <h2>AI innenfor brukerstøtte</h2>
            <p>
             <asp:Label ID="LabelAI" runat="server" Text="Label"></asp:Label>
            </p>

            <asp:TextBox ID="TextBoxEditOnPage" Visible="false" runat="server" TextMode="MultiLine"></asp:TextBox>

            <p>
                <asp:Button ID="AIEdit" CssClass="btn btn-default" Visible="false" runat="server" Text="Edit" OnClick="AIEdit_Click" />
            </p>
